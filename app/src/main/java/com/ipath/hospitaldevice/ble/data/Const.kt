...
object Const {
    ...
    val UUID_SERVICE_DATA_GlucoMeter = UUID.fromString("0000fc00-0000-1000-8000-00805f9b34fb")
    val UUID_CHARACTER_RECEIVE_GlucoMeter = UUID.fromString("0000fca1-0000-1000-8000-00805f9b34fb")
